...
- - recovery: содержит всё, что в boot, но и имеет ramdisk с busybox от какой то левой консоли, не используется, само рекавери никак не запускается, тоже просто ради "галочки".
